...
EXTERN	Prog*	lastp;
EXTERN	int32_t	lcsize;
EXTERN	char	literal[32];
EXTERN	int	nerrors;
EXTERN	int32_t	nhunk;
EXTERN	Prog	nopalign;
EXTERN	int32_t	instoffset;
...
EXTERN	int32_t	symsize;
EXTERN	Prog*	textp;
EXTERN	int32_t	textsize;
...
int	compound(Prog*);
double	cputime(void);
void	datblk(int32_t, int32_t, int);
void	diag(char*, ...);
void	dodata(void);
void	doprof1(void);
void	doprof2(void);
...
void	errorexit(void);
void	exchange(Prog*);
int	find1(int32_t, int);
void	follow(void);
void	gethunk(void);
void	histtoauto(void);
double	ieeedtod(Ieee*);
int32_t	ieeedtof(Ieee*);
int	isnop(Prog*);
void	ldobj(int, int32_t, char*);
void	loadlib(void);
void	listinit(void);
Sym*	lookup(char*, int);
void	cput(int);
