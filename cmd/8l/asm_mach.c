...
asmb(void)
{
	...
	case 3:	/* Mach-o */
		/* header, 7 longs */
		lputl(0xfeedfaceL);			/* magic */
		lputl(7);				/* I386 */
		lputl(3);				/* any sub-type */
		lputl(2);				/* file type 'MH_PRELOAD' */
		lputl(3);				/* number commands */
		lputl(HEADR-7*4);			/* sizeof commands */
		lputl(1);				/* flag MH_NOUNDEFS */
		/* command 1 text */
		lputl(1);				/* command = 'LC_SEGMENT' */
		lputl(124);				/* command size */
		s16put("__TEXT");
			/* botch?? entryvalue() */
		lputl(INITTEXT);			/* va of start */
		lputl(rnd(textsize, 8192));		/* va size */
		lputl(HEADR);				/* file offset */
		lputl(rnd(textsize, 8192));		/* file size */
		lputl(7);				/* max prot */
		lputl(7);				/* init prot */
		lputl(1);				/* number of sections */
		lputl(0);				/* flags */
		/* text section */
		s16put("__text");
		s16put("__TEXT");
		...
		lputl(0);				/* reserved2 */
		/* command 1 data */
		lputl(1);				/* command = 'segment' */
		lputl(192);				/* command size */
		s16put("__DATA");
		lputl(INITDAT);				/* va of start */
		lputl(rnd(datsize, 8192));		/* va size */
		lputl(HEADR+rnd(textsize, 8192));	/* file offset */
		lputl(rnd(datsize, 8192));		/* file size */
		lputl(7);				/* max prot */
		lputl(7);				/* init prot */
		lputl(2);				/* number of sections */
		lputl(0);				/* flags */
		/* data section */
		s16put("__data");
		s16put("__DATA");
		lputl(INITDAT);				/* va of start */
		lputl(datsize);				/* va size */
		lputl(HEADR+rnd(textsize, 8192));	/* file offset */
		lputl(2);				/* align */
		lputl(0);				/* reloff */
		lputl(0);				/* nreloc */
		...
		s16put("__bss");
		s16put("__DATA");
		lputl(INITDAT+datsize);			/* va of start */
		lputl(bsssize);				/* va size */
		lputl(0);				/* file offset */
		lputl(2);				/* align */
		lputl(0);				/* reloff */
		lputl(0);				/* nreloc */
		lputl(1);				/* flags = zero fill */
		lputl(0);				/* reserved1 */
		lputl(0);				/* reserved2 */
		/* command 2 symbol */
		lputl(2);				/* command = 'symbol' */
		lputl(24);				/* command size */
		lputl(HEADR+rnd(textsize, INITRND)
			+datsize);			/* symoff */
		lputl(symsize);				/* nsyms */
		lputl(spsize);				/* sp offsets */
		lputl(lcsize);				/* line offsets */
		break;
	case 4:
		/* fake MS-DOS .EXE */
